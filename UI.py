...
class Hud:
    ...
    #Menu_Buttons = {
    #    "Play":pygame.image.load("Slime Survival\Buttons text pack\play.png"),
    #    "Restart":pygame.image.load("Slime Survival\Buttons text pack\\restart.png"),
    #    "Leaderboard":pygame.image.load("Slime Survival\Buttons text pack\leaderboard.png")
    #}
    ...
    def __init__(self,player,score = 0):
        ...
        self.score = score
        self.text_font = pygame.font.Font("Slime Survival\Fonts\Grand9K Pixel.ttf",25)
        self.round_text_font = pygame.font.Font("Slime Survival\Fonts\Grand9K Pixel.ttf",125)
